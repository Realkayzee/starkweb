const enUS = {
  ...
  signInWithEthereumScreen_tooltip:
    'You’re not signed in to this app.\n**Sign In With Starknet** to continue.',

  signInWithEthereumScreen_signedOut_heading: 'Sign In With Starknet',
  ...
  signInWithEthereumScreen_signedIn_heading: 'Signed In With Starknet',
