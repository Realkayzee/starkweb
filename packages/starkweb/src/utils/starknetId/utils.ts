import { StarknetChainId } from '../../constants/starknet.js'
/* eslint-disable no-param-reassign */
import { ZERO } from '../../strk-types/constants.js'
 ...
 * @returns string
 */
export function getPfpVerifierContract(chainId: StarknetChainId): string {
  const starknetIdMainnetContract =
 ...
 * @returns string
 */
export function getPopVerifierContract(chainId: StarknetChainId): string {
  const starknetIdMainnetContract =
 ...
 * @returns string
 */
export function getMulticallContract(chainId: StarknetChainId): string {
...
export function getBlobbertContract(chainId: StarknetChainId): string {
  switch (chainId) {
    case StarknetChainId.SN_MAIN:
 ...
 * @returns string
 */
export function getUtilsMulticallContract(chainId: StarknetChainId): string {
