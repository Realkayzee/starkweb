...
export type BLOCK_WITH_TXS = { status: BLOCK_STATUS } & BLOCK_HEADER &
  BLOCK_BODY_WITH_TXS
...
export type PENDING_BLOCK_WITH_RECEIPTS = BLOCK_BODY_WITH_RECEIPTS &
  PENDING_BLOCK_HEADER
...
export type API_VERSION = ApiVersion
export type SPEC_VERSION = SpecVersion
export type STARKNET_CHAIN = StarknetChain
export type PERMISSION = Permission
export type ASSET = Asset
export type ACCOUNT_DEPLOYMENT_DATA = AccountDeploymentData
export type INVOKE_CALL = {}
export type TYPED_DATA = TypedData
