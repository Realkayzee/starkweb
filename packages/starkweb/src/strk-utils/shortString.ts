import { TEXT_TO_FELT_MAX_LEN } from '../strk-types/constants.js'
 ...
 * ```
 */
export const isShortText = (val: any): boolean =>
  isText(val) && isShortString(val)
 ...
 * ```
 */
export const isLongText = (val: any): boolean =>
  isText(val) && !isShortString(val)
